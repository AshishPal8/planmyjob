      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <Link href="/ats-checker" className="nav-link text-sm font-semibold text-primary">
              ATS Checker
            </Link>
          ...
          {/* Right actions (Desktop only - Mobile uses bottom floating pill bar) */}
          <div className="hidden lg:flex items-center gap-1 md:gap-3">
            {user && (user.role === "admin" || user.role === "superadmin") && (
              <Link
                href="/admin"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-primary text-white text-xs font-semibold hover:bg-primary/90 shadow-sm transition-all"
              >
                <Shield size={13} />
